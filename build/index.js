...
var DinoGameInternal = function () {
    ...
    var dinoRef = react.useRef(null);
    var cactusRef = react.useRef(null);
    var _b = react.useState(0), score = _b[0], setScore = _b[1];
    var _c = react.useState(false), isJumping = _c[0], setIsJumping = _c[1];
    var gameOver = false;
    // Jump Logic
    var jump = function () {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: "game" }, { children: [jsxRuntime.jsxs("div", __assign({ className: "mountains" }, { children: [jsxRuntime.jsx("div", { className: "mountain mountain1" }), jsxRuntime.jsx("div", { className: "mountain mountain2" })] })), jsxRuntime.jsx("div", __assign({ className: "bumpy-wrapper" }, { children: jsxRuntime.jsx("svg", __assign({ className: "bumpy-svg", viewBox: "0 0 600 100", preserveAspectRatio: "none" }, { children: jsxRuntime.jsx("path", { className: "bumpy-path", d: "M0,100 \n         L0,80 \n         Q30,60 60,80 \n         Q90,40 120,80 \n         Q150,60 180,70 \n         Q210,30 240,80 \n         Q270,50 300,70 \n         Q330,40 360,80 \n         Q390,60 420,70 \n         Q450,50 480,80 \n         Q510,60 540,70 \n         Q570,55 600,80 \n         L600,100 Z" }) })) })), jsxRuntime.jsx("div", { className: "tree tree1" }), jsxRuntime.jsx("div", { className: "tree tree2" }), jsxRuntime.jsx("div", { className: "tree tree3" }), jsxRuntime.jsx("div", { className: "cloud cloud1" }), jsxRuntime.jsx("div", { className: "cloud cloud2" }), jsxRuntime.jsx("div", { className: "ground" }), jsxRuntime.jsx("div", __assign({ ref: dinoRef, className: "dino" }, { children: jsxRuntime.jsx("img", { style: { width: '100%' }, src: "https://img.itch.zone/aW1hZ2UvNTA5MzIwLzI2NDIzNTEucG5n/347x500/kwmG6Z.png" }) })), jsxRuntime.jsx("div", __assign({ ref: cactusRef, className: "cactus" }, { children: jsxRuntime.jsx("img", { style: { width: '100%' }, src: "https://img.itch.zone/aW1hZ2UvNTA5MzIwLzI2NDIzNTcucG5n/347x500/%2FqbQKf.png" }) })), jsxRuntime.jsxs("div", __assign({ className: "score" }, { children: ["Score: ", score] }))] })));
};
